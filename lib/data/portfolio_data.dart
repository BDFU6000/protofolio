...
class PortfolioData {
  ...
  static const List<SkillModel> skills = [
    SkillModel(
        name: 'Flutter & Dart', emoji: '💙', level: 0.95, color: '02569B'),
    ...
    SkillModel(
        ...
        color: '3ECF8E'),
    SkillModel(
        name: 'Python (AI & Scraping)',
        emoji: '🐍',
        level: 0.85,
        color: '3776AB'),
    SkillModel(
        name: 'Riverpod & State Mgmt',
        emoji: '🌊',
        level: 0.90,
        color: '02569B'),
    SkillModel(
    ...
    SkillModel(
        ...
        color: 'F24E1E'),
    SkillModel(
        name: 'No-Code / n8n', emoji: '🤖', level: 0.80, color: 'FF6C37'),
  ...
  static const List<ExperienceModel> arabicExperiences = [
    ExperienceModel(
        ...
        period: '2026',
        description:
            'تم بناء الذكاء الاصطناعي المحلي لسيناريوهات محددة ليكون بمثابة وكيل ذكاء اصطناعي رؤى لمنتج البرمجيات كخدمة (SaaS) الذي قمت ببنائه، وليتم استخدامه في مشاريع أخرى أيضًا.',
        technologies: [
          'Python',
          'TensorFlow',
          'PyTorch',
        ...
        emoji: '🧠'),
    ExperienceModel(
      role: 'ذكاء اصطناعي مساعد',
      company: 'مستقل / مصدر مفتوح',
      period: 'أبريل 2026',
      description:
          'طورت نظاماً متكاملاً لكشط منشورات الوظائف من تليجرام باستخدام Telethon، وتصنيف البيانات بالذكاء الاصطناعي (Ollama Llama 3) وإثرائها عبر Google Places API وتوليد رسائل تسويق ذكية عبر Groq مع المزامنة مع جداول بيانات جوجل المباشرة. وRiverpod.',
      technologies: [
        'Python',
        'Telethon',
        'Ollama (Llama 3)',
    ...
    ExperienceModel(
      ...
      period: 'نهاية 2025',
      description:
          'قمت بتصميم وبناء DoctorLeandak، وهو تطبيق رعاية صحية شامل يربط بين المرضى والأطباء والصيدليات وموظفي التوصيل. دمجت خرائط جوجل في الوقت الفعلي ومراسلة Firebase وتعديل كامل البنية لتعتمد على معرفات UUID.',
    ...
    ExperienceModel(
      ...
      period: '2024',
      description:
          'قمت بإنشاء ونشر أول مشروع رئيسي لي، وهو نظام العيادة العامة. بنيت أساس خبرتي في التطبيقات الطبية باستخدام إدارة الحالة الحديثة والبنية القابلة للتطوير.',
  ...
  static const List<ExperienceModel> englishExperiences = [
    ExperienceModel(
      ...
      period: '2026',
      description:
          'Built Local AI for specific scenarios to be as insght Ai Agent for the SAAS product I built, and to be used in other projects as well. ',
      technologies: [
        'Python',
        'TensorFlow',
        'PyTorch',
    ...
    ExperienceModel(
      ...
      period: 'April 2026',
      description:
          'Developed an automated Telegram job scraping pipeline using Telethon , local AI (Ollama Llama 3) for parsing, Google Places API for company contact enrichment, and Groq Cloud API for generating targeted B2B WhatsApp pitches synced live to Google Sheets.',
      technologies: [
        'Python',
        'Telethon',
        'Ollama (Llama 3)',
    ...
    ExperienceModel(
        role: 'SaaS ERP System For Clinics',
        company: 'Clinic',
        period: '2026',
        description:
            'Smart Clinic System a full-featured Enterprise Resource Planning (ERP) application designed for multi-tenant clinic management. Built with Flutter and powered by Supabase (PostgreSQL), it provides a complete solution for managing medical practices, from appointments and patient records to HR, billing, and inventory.',
        technologies: [
          'Flutter',
          'Supabase',
          'PostgreSQL',
    ...
    ExperienceModel(
      ...
      technologies: ['C#', 'Dart', 'State Management'],
      emoji: '🏥',
    ),
  ];

  static List<ExperienceModel> get experiences =>
      LocaleProvider.isArabic.value ? arabicExperiences : englishExperiences;
  ...
  static const List<ProjectModel> arabicProjects = [
    ProjectModel(
      ...
      description:
          'تطبيق ERP شامل ومتعدد المستأجرين مصمم لإدارة العيادات. يدعم 11 دوراً مميزاً للمستخدمين ويدير 8 وحدات طبية وإدارية.',
      ...
      detailedSections: [
        ProjectDetailSection(
          title: 'بنية النظام',
          content:
              'تم بناء النظام كمنصة ERP متعددة المستأجرين. يعتمد على فلاتر لواجهة مستخدم متجاوبة ويعتمد بشدة على Riverpod لإدارة حالة يمكن التنبؤ بها وقابلة للتطوير.',
          iconEmoji: '🏗️',
        ),
        ProjectDetailSection(
          title: 'التحكم في الوصول',
          content:
              'يدير النظام بشكل آمن 11 دوراً (مالك النظام، مسؤول العيادة، طبيب، ممرض، إلخ). كل إجراء محمي بسياسات RLS صارمة من Supabase لضمان الخصوصية.',
          iconEmoji: '🔐',
        ),
        ProjectDetailSection(
          title: 'الوحدات الأساسية',
          content:
              'يحتوي على 8 وحدات مدمجة بالكامل بما في ذلك جدولة المواعيد في الوقت الفعلي، السجلات الطبية (EMR)، تتبع الصيدلية والمخزون، وإدارة الموارد البشرية.',
          iconEmoji: '⚙️',
        ),
      ],
    ),
    ProjectModel(
      title: 'DoctorLeandak',
      description:
          'نظام شامل لإدارة الرعاية الصحية يربط بين المرضى والأطباء والصيدليات وموظفي التوصيل. يتميز بمصادقة متعددة الأدوار وتحديثات طبية في الوقت الفعلي.',
      ...
      detailedSections: [
        ProjectDetailSection(
          title: 'نظام الخدمات',
          content:
              'يسد التطبيق الفجوة بين الأطراف الصحية المتعددة. يوفر مسارات مخصصة للمرضى والأطباء والصيدليات، تتواصل جميعها بسلاسة عبر خلفية موحدة.',
          iconEmoji: '🌐',
        ),
        ProjectDetailSection(
          title: 'اتصال في الوقت الفعلي',
          content:
              'يستخدم Supabase Realtime و Firebase FCM لتنبيه الأطباء فوراً، وإشعار المرضى بحالة الوصفات، وتتبع التوصيل الطارئ عبر خرائط جوجل.',
          iconEmoji: '⚡',
        ),
        ProjectDetailSection(
          title: 'إدارة البيانات الطبية',
          content:
              'يتعامل بأمان مع تاريخ المرضى، والوصفات الرقمية، ومكالمات الطوارئ. تم ترحيل قاعدة البيانات إلى بنية علائقية تعتمد على UUID لدعم التوسع الهائل.',
          iconEmoji: '🗄️',
        ),
      ],
    ),
    ProjectModel(
      ...
      description:
          'نظام بايثون متكامل لكشط منشورات الوظائف من قنوات تليجرام في الوقت الفعلي، واستخلاص بيانات الشركات، وإثرائها باستخدام Google Places API وتوليد رسائل B2B مخصصة عبر Groq Cloud، مع المزامنة الفورية لجداول بيانات جوجل.',
      technologies: [
        'Python',
        'Telethon',
        'Ollama (Llama 3)',
      ...
      liveUrl:
          'https://docs.google.com/spreadsheets/d/16ZONKqGDntWeHtt9qioxUlpQ2bSFLbrtKTM-2z3EQmA/edit?usp=sharing',
      detailedSections: [
        ProjectDetailSection(
          title: 'كشط البيانات والتحكم في القيود (Telethon)',
          content:
              'تطبيق غير متزامن مبني بمكتبة Telethon يرصد القنوات المستهدفة (مثل Libyanjobs و ziadjobs) لجلب الإعلانات فورياً أو تاريخياً دفعة واحدة، مع آلية تأخير ذكي عشوائي (2-5 ثوانٍ) لتفادي حظر API من تليجرام.',
          iconEmoji: '🔍',
        ),
        ProjectDetailSection(
          title: 'استخلاص وهندسة الأوامر (Llama 3)',
          content:
              'خادم Flask محلي يوجه نصوص الوظائف الخام لنموذج Llama 3 محلي عبر Ollama لاستخراج أسماء الشركات، المسميات الوظيفية، البريد، والهاتف، مع استنتاج نقاط الضعف وصياغة عرض مخصص وتنسيقه كملف JSON.',
          iconEmoji: '🧠',
        ),
        ProjectDetailSection(
          title: 'إثراء البيانات وجداول جوجل الحية (Groq & Places)',
          content:
              'يقوم بالبحث عن معرف الشركة في خرائط جوجل لجلب الهاتف المعتمد والبريد والموقع الجغرافي. يمرر النتائج لـ Groq API (Llama 3.1) لتصنيف التخصص وكتابة رسالة B2B للواتساب تقل عن 40 كلمة، ثم يرفع البيانات لحظياً إلى جدول بيانات جوجل.',
          iconEmoji: '📊',
        ),
      ],
    ),
    ...
    ProjectModel(
      ...
      detailedSections: [
        ProjectDetailSection(
          ...
          content:
              'SmartClinic is built as a multi-tenant Enterprise Resource Planning (ERP) platform. '
        ...
        ProjectDetailSection(
          ...
          content:
              'The system securely manages 11 distinct user roles (System Owner, Clinic Admin, Doctor, '
        ...
        ProjectDetailSection(
          title: 'Core Modules',
          content:
              'Contains 8 fully integrated modules including real-time Appointment Scheduling, '
    ...
    ProjectModel(
      ...
      detailedSections: [
        ProjectDetailSection(
          ...
          content:
              'DoctorLeandak bridges the gap between multiple healthcare stakeholders. It provides '
        ...
        ProjectDetailSection(
          ...
          content:
              'Utilizes Supabase Realtime and Firebase Cloud Messaging (FCM) to instantly alert '
        ...
        ProjectDetailSection(
          ...
          content:
              'Securely handles patient histories, digital prescriptions, and emergency calls. '
  ...
  static List<ProjectModel> get projects =>
      LocaleProvider.isArabic.value ? arabicProjects : englishProjects;
